...
EXECUTABLE_EXTENSIONS: Final[frozenset[str]] = frozenset(
    {
        ".exe", ".dll", ".scr", ".com", ".pif", ".cpl", ".msi", ".msp", ".jar",
        ".bat", ".cmd", ".ps1", ".psm1", ".vbs", ".vbe", ".js", ".jse", ".wsf",
        ".wsh", ".hta", ".lnk", ".reg", ".sh", ".elf", ".app", ".apk", ".iso",
        ".img", ".vhd", ".chm", ".sys", ".scf", ".inf",
    }
)
...
URL_SHORTENER_HOSTS: Final[frozenset[str]] = frozenset(
    {
        ...
        "s.id", "t.ly", "shorte.st", "adf.ly", "bc.vc", "clck.ru", "v.gd",
    }
)
...
SUSPICIOUS_TLDS: Final[frozenset[str]] = frozenset(
    {
        ...
        ".click", ".link", ".work", ".loan", ".download", ".stream", ".review",
        ".country", ".kim", ".science", ".party", ".gdn", ".men", ".date",
    }
)
